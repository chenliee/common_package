...
//   ) {
//     CityTree citiesTreeBuilder = CityTree();
//
...
//     String name = provincesData[provinceId]!;
//     String letter = PinyinHelper.getFirstWordPinyin(name).substring(0, 1);
//     var root =
//         Point(code: provinceId, letter: letter, children: [], name: name);
//     tree = _buildTree(root, citiesData[provinceId], citiesData);
//     return tree;
//   }
//
//   Point _buildTree(Point target, Map<String, dynamic>? city, Map meta) {
//     if (city == null || city.isEmpty) {
//       return target;
//     } else {
//       List<String> keys = city.keys.toList();
//
...
//         //        }
//         //    }
//         if (city.keys.length == 1) {
//           if (target.code.toString() == city.keys.first) {
//             continue;
//           }
//         }
//
